...
class Grade_barang extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Grade Barang';
		$data_content['breadcrumb']   = 'Grade Barang';
		$data_content['breadcrumb1']  = 'Grade Barang List';


		$config["js"] = 'grade_barang/index';
		$config["content_file"] = "grade_barang/index";
	...
	public function table_list($all_data, $recordsTotal, $recordsFiltered)
	{
		...
		foreach ($all_data as $key => $val) {
			...
			$btn_grade = '<button type="button" onclick="myForm_edit(' . $val->id . ')" class="btn btn-outline-primary btn-sm">
						<i data-feather="edit-3"></i> Masukan Grade</button>';
			$number++;
			$row = array();
			$row[] = $btn_grade;
			$row[] = $val->po_no;
	...
	public function form()
	{
		...
		$data_content['title']        = 'Grade Barang';
		$data_content['breadcrumb']   = 'Grade Barang';
		$data_content['breadcrumb1']  = 'Grade Barang Form';
		$data_content['status_form']  = 0;
		$data_content['barang']  = $barang;


		$config["content_file"] = "grade_barang/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Grade Barang';
		$data_content['breadcrumb']   = 'Grade Barang';
		$data_content['breadcrumb1']  = 'Grade Barang Form Edit';
