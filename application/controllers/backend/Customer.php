...
class Customer extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Customer';
		$data_content['breadcrumb']   = 'Customer';
		$data_content['breadcrumb1']  = 'Customer List';


		$config["js"] = 'customer/index';
		$config["content_file"] = "customer/index";
	...
	public function form()
	{
		...
		$data_content['title']        = 'Customer';
		$data_content['breadcrumb']   = 'Customer';
		$data_content['breadcrumb1']  = 'Customer Form';
		$data_content['status_form']  = 0;

		$config["content_file"] = "customer/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Customer';
		$data_content['breadcrumb']   = 'Customer';
		$data_content['breadcrumb1']  = 'Customer Form Edit';
