...
class Parameter extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content['breadcrumb']   = 'Parameter';
		$data_content['breadcrumb1']  = 'Parameter List';


		$config["js"] = 'parameter/index';
		$config["content_file"] = "parameter/index";
	...
	public function form()
	{
		...
		$config["content_file"] = "parameter/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Parameter';
		$data_content['breadcrumb']   = 'Parameter';
		$data_content['breadcrumb1']  = 'Parameter Form Edit';
	...
	{
		$data = array();
		$data['param_variable'] 	= $_POST["param_variable"];
		$data['param_id'] 	= $_POST["param_id"];
		$data['param_value'] 	= $_POST["param_value"];
