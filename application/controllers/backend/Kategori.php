...
class Kategori extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Kategori';
		$data_content['breadcrumb']   = 'Kategori';
		$data_content['breadcrumb1']  = 'Kategori List';


		$config["js"] = 'kategori/index';
		$config["content_file"] = "kategori/index";
	...
	public function form()
	{
		...
		$data_content['title']        = 'Kategori';
		$data_content['breadcrumb']   = 'Kategori';
		$data_content['breadcrumb1']  = 'Kategori Form';
		$data_content['status_form']  = 0;

		$config["content_file"] = "kategori/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Kategori';
		$data_content['breadcrumb']   = 'Kategori';
		$data_content['breadcrumb1']  = 'Kategori Form Edit';
