...
class Admin extends CI_Controller
{
	...
	{
		/* SELECT DATA ALL */
		$this->db->select("*,(SELECT param_value FROM ms_parameter WHERE param_id = table1.id_role AND param_variable = 'ROLE') AS role");
	...
	public function form_edit($param)
	{
		...
		$query = $this->db->query("SELECT table1.*,t2.param_value
										FROM {$this->table} table1
										LEFT JOIN ms_parameter t2 ON t2.param_id = table1.id_role AND t2.param_variable = 'ROLE'
