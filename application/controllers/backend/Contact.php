...
class Contact extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Contact';
		$data_content['breadcrumb']   = 'Contact';
		$data_content['breadcrumb1']  = 'Contact List';


		$config["js"] = 'contact/index';
		$config["content_file"] = "contact/index";
	...
	public function form()
	{
		...
		$data_content['title']        = 'Contact';
		$data_content['breadcrumb']   = 'Contact';
		$data_content['breadcrumb1']  = 'Contact Form';
		$data_content['status_form']  = 0;

		$config["content_file"] = "contact/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Contact';
		$data_content['breadcrumb']   = 'Contact';
		$data_content['breadcrumb1']  = 'Contact Form Edit';
