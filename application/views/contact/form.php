    								...
    								<form class="form form-horizontal" id="form-main">
    									...
    									<div class="row">
    										<div class="col-12">
    											<div class="form-group row">
    												<div class="col-sm-3 col-form-label">
    													<label for="first-name">Lokasi</label>
    												</div>
    												<div class="col-sm-9">
    													<input type="text" class="form-control" name="lokasi" placeholder="Lokasi" value="<?= isset($all_data->lokasi) ? $all_data->lokasi : '' ?>" />
    												</div>
    											</div>
    										</div>
    										<div class="col-12">
    											<div class="form-group row">
    												<div class="col-sm-3 col-form-label">
    													<label for="first-name">Maps</label>
    												</div>
    												<div class="col-sm-9">
    													<input type="text" class="form-control" name="maps" placeholder="Maps" value="<?= isset($all_data->maps) ? $all_data->maps : '' ?>" />
    												</div>
    											</div>
    										</div>
    										...
    										<div class="col-12">
    											<div class="form-group row">
    												<div class="col-sm-3 col-form-label">
    													<label for="first-name">Telepon</label>
    												</div>
    												<div class="col-sm-9">
    													<input type="number" class="form-control" name="telepon" placeholder="Nama Telepon" value="<?= isset($all_data->telepon) ? $all_data->telepon : '' ?>" />
    												</div>
    											</div>
    										</div>
