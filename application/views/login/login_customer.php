...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover"
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1">LOGIN CUSTOMER</h4>
                                ...
                                <form class="auth-register-form mt-2">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="register-privacy-policy">Remember
                                                me
                                            </label>
                                        </div>
                                    </div>
                                    <button class="btn btn-primary btn-block save" tabindex="5">Login</button>
                                    <span>Belum punya akun?<a href="<?= BACKEND_URL . 'login/register' ?>">Daftar
                                            disini</a>
                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="<?= FRONTEND_URL . 'home' ?>" class="btn btn-secondary btn-block"
                                                tabindex="5">Kembali Ke
                                                Toko</a>
                                        </div>
                                        <div class="col-6">
                                            <a href="<?= BACKEND_URL . 'login' ?>"
                                                class="btn btn-primary btn-block save" tabindex="5">Login
                                                Admin</a>
                                        </div>
                                    </div>
                                </form>
    ...
    <script src="<?= ASSETS_ROOT ?>vendors/js/forms/validation/jquery.validate.min.js">
    </script>
    <!-- END: Page Vendor JS-->
    ...
    <script src="<?php echo ASSETS_ROOT ?>vendors/js/extensions/toastr.min.js">
    </script>
        ...
        if (page.length) {
            page.validate({
                ...
                submitHandler: function(page) {
                    $.ajax({
                        url: "<?php echo base_url('backend/login/login_customer_proccess') ?>",
                        type: "POST",
                        data: $(page).serialize(),
                        dataType: "json",
                        beforeSend: function() {
                        ...
                        success: function(data) {
                            if (data.error ==
                                ...
                                window.location.href =
                                    '<?php echo base_url('frontend/home') ?>';
                                // history.go(-1)
